...
namespace Proiect_C_.Forms
{
    public partial class YourBookings : Form
    {
        ...
        private void printDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(identificationInfo, fontPrincipal, brush, profilePictureX - 10, profilePictureY + profilePictureHeight + 20);
            ...
            { 
                Booking booking = Bookings[Bookings.Count-noOfBookings];
        ...
        private void printBtn_Click(object sender, EventArgs e)
        {
            ...
            printDocument.PrinterSettings.PrintFileName = $"Bookings_of_{Client.FirstName}_{Client.LastName}.pdf";
            printDocument.Print();
            ...
            {
                var bodyBuilder = new BodyBuilder();
                bodyBuilder.Attachments.Add($"Bookings_of_{Client.FirstName}_{Client.LastName}.pdf");
                ...
                File.Delete($"Bookings_of_{Client.FirstName}_{Client.LastName}.pdf");
